...
WebUI.click(findTestObject('Object Repository/Page_Budget Management System/a_Savings History'))

Thread.sleep(2000)
WebUI.click(findTestObject('Object Repository/Page_Budget Management System/a_Logout'))
